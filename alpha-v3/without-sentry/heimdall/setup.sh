...
sudo chown -R ubuntu:ubuntu $HEIMDALL_HOME/data 
sudo chown -R ubuntu:ubuntu $HEIMDALL_HOME/config

# init heimdall node
heimdalld init --id ${validator_id} --chain-id "heimdall-417" --home /data
